...
namespace GameMain
{
    ...
    /// 游戏框架入口。
    /// </summary>
    public static class GameMainEntry
    {
        private const string GameFrameworkVersion = "1.1.0";//游戏GameFramework版本号
        private static readonly LinkedList<GameFrameworkModule> s_GameFrameworkModules = new LinkedList<GameFrameworkModule>();

        private static GameMainEntryComponent m_GameMainEntryComponent;
        /// <summary>
        /// 获取游戏框架版本号。
        /// </summary>
        ...
        public static LinkedList<GameFrameworkModule> GameFrameworkModules
        {
            get
            {
                return s_GameFrameworkModules;
            }
        }
        public static GameMainEntryComponent GameMainEntryComponent
        {
            get
            {
                return m_GameMainEntryComponent;
            }
            set
            {
                m_GameMainEntryComponent = value;
            }
